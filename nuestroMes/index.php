    ...
    <div class="container">
        ...
        <section class="categorias">
            ...
            <div class="grid-categorias" role="navigation" aria-label="Categorías de mensajes">
                <a href="mensajes.php?categoria=feliz" class="categoria-card feliz" aria-label="Ver mensajes para cuando estés feliz">
                    <div class="icono" role="img" aria-label="Emoji feliz">😄</div>
                    <h3>Cuando estés feliz</h3>
                    <p>Celebremos juntos tu alegría</p>
                </a>

                <a href="mensajes.php?categoria=triste" class="categoria-card triste" aria-label="Ver mensajes para cuando estés triste">
                    <div class="icono" role="img" aria-label="Emoji triste">😢</div>
                    <h3>Cuando estés triste</h3>
                    <p>Deja que te abrace con palabras</p>
                </a>

                <a href="mensajes.php?categoria=enojada" class="categoria-card enojada" aria-label="Ver mensajes para cuando estés enojada">
                    <div class="icono" role="img" aria-label="Emoji enojado">😤</div>
                    <h3>Cuando estés enojada</h3>
                    <p>Respira... aquí estoy para ti</p>
                </a>

                <a href="mensajes.php?categoria=amor" class="categoria-card amor" aria-label="Ver mensajes sobre por qué te amo">
                    <div class="icono" role="img" aria-label="Emoji corazón">❤️</div>
                    <h3>Por qué te amo</h3>
                    <p>Las razones nunca terminan</p>
                </a>

                <a href="mensajes.php?categoria=nostalgia" class="categoria-card nostalgia" aria-label="Ver mensajes para cuando me extrañes">
                    <div class="icono" role="img" aria-label="Emoji luna">🌙</div>
                    <h3>Cuando me extrañes</h3>
                    <p>Estoy más cerca de lo que piensas</p>
                </a>

                <a href="mensajes.php?categoria=motivacion" class="categoria-card motivacion" aria-label="Ver mensajes motivacionales">
